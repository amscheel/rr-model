...
In Chapter 2, we presented initial evidence that published Registered Reports have a substantially lower rate of positive results than regular articles in psychology [$44\%$ vs $96\%$, @Scheel2021a].
...
<!-- because  -->
<!-- why we found Registered Reports to have `r 96-44` percentage points fewer positive results than standard reports, and that a difference in publication bias and QRPs plays no role  -->
 <!-- that the very high rate of positive results in the standard literature is a product of these factors. -->
...
<!-- considering in which situations Registered Reports are likely to be used or avoided. -->
...
As Registered-Reports advocate Chris Chambers once put it ([September 2021](https://youtu.be/FiVI3cwVMZI?list=PLChfyH8TVDGmYENpXUDPaeeq2SLh8q9dt&t=1047)):
...
<!-- could seen as the time and resources a researcher has available for producing publications  -->
