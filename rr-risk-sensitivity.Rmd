...
The [code](https://github.com/amscheel/rr-model/tree/master/code) required for reproducing all analyses and figures reported here and the [Appendix](https://osf.io/qw798/), are available at <https://github.com/amscheel/rr-model>.
