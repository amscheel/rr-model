...
This document contains additional figures for the manuscript `\emph{Career incentives make Registered Reports unattractive under realistic academic conditions}'. This PDF was created in RMarkdown. The reproducible RMarkdown file is available in our online repository at \url{https://github.com/amscheel/rr-model/}.
